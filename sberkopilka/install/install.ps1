# Install SberKopilka kiosk. Python can be bundled in runtime\python or installed system-wide.
param(
    [switch]$Offline
)
...
Write-Host "=== SberKopilka kiosk install ===" -ForegroundColor Cyan
...
Update-SberKopilkaEnvDefaults -Root $Root
...
Write-Host "  or install\start-sberkopilka.cmd"
Write-Host "Kiosk: http://127.0.0.1:8766"
